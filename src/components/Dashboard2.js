...
let innerCards;
let arr = new Array("ban", "can", "ton", "men");
let array2 = [
    {title:" Students",total_students:"100",create:"Add students"},
    {title:" Lecturers",total_lecs:"300",create:"Add Lectuers"},
    {title:" staff",total_staff:"200",create:"Add Staff"},
    {title:" employees",total_students:"100",create:"Add Employees"},
]
                ...
                <div className="ecommerce-widget">
                  ...
                  <div className="row">
                        ...
                        <div className="card-body p-0">
                          <ul className="social-sales list-group list-group-flush">
                            <li className="list-group-item social-sales-content">
                              ...
                              <span className="social-sales-name">
                                Facebook
                              </span>
                              <span className="social-sales-count text-dark">
                                120 Sales
                              </span>
                            </li>
                            <li className="list-group-item social-sales-content">
                    ...
                    <div className="col-xl-3 col-lg-12 col-md-6 col-sm-12 col-12">
                      <div className="card">
                        <h5 className="card-header">
                          Sales By Country Traffic Source
                        </h5>
                        <div className="card-body p-0">
                          <ul className="country-sales list-group list-group-flush">
                            ...
                            <li className="list-group-item country-sales-content">
                              <span className="mr-2">
                                <i
                                  className="flag-icon flag-icon-ca"
                                  title="ca"
                                  id="ca"
                                />
                              </span>
